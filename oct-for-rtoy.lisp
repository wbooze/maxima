...
(defmacro make-qd-d (a) `(%make-oct ,a 0d0 0d0 0d0))
)
...
;;;; arguably, this sin/cos/tan/exp/log/sinh/cosh etc should be supported only at
;;;; the quad-real and quad-complex level. After all, sqrt-qd might return an imaginary.
;;;; also one might need (sin <qd-complex>) too.
