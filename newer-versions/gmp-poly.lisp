...
(in-package :gmp)
;; broken  04/10/06 /rjf.  need to be smarter about operations on gmp vs. integer exponents.
...
(defmethod ga::two-arg-* ((v1 gmp-pol)(v2 gmp-pol))
	;;....
  )
...
(defun pr(r)(cond ((coefp r) (gmp::gmpz2lisp r));; make the poly readable?
